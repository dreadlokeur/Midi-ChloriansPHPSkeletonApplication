...
$config = array(
    ...
    'csrf' => array(
        'adaptater' => 'csrf', //class name (implement \MidiChloriansPHP\security\IAdaptater)
    ...
    'captcha' => array(
        'adaptater' => 'captcha', // class name (implement \MidiChloriansPHP\security\IAdaptater)
        'autorun' => false, //autorun (optionnal default is false)
    ...
    'crawler' => array(
        'adaptater' => 'crawler', // class name (implement \MidiChloriansPHP\security\IAdaptater)
    ...
    /*'flooder' => array(
        'adaptater' => 'flooder', // class name (implement \MidiChloriansPHP\security\IAdaptater)
        'autorun' => false, // autorun (optionnal default is false)
